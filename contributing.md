Contributing to TeaCollection

Спасибо за интерес к вкладу в TeaCollection! В этом документе описаны основные правила и рекомендации для участников.
...
git clone https://github.com/DIMAKOZHEMYAKA/TeaCollection.git
